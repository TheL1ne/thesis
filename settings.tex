...
\setboolean{isPrintMode}{false}
  \setboolean{showExampleChapter}{false}%only appears if isPrintMode is set to false
  \setboolean{showNotes}{false}%only appears if isPrintMode is set to false
